...
#if TK_FREQ_JUMP_EN
unsigned char xdata TfrcFreq1Cfg;
unsigned char xdata TfrcFreq2Cfg;
#if  (JUMP_FREQ_NUM > 2)
unsigned char xdata TfrcFreq3Cfg;
#endif
unsigned char xdata NowTKFreqIndex;
unsigned char xdata TKFreqJumpStep;
#endif
unsigned int  TS_Key;	
...
#if TK_FREQ_JUMP_EN
unsigned int 	xdata 	TS_JumpFreqData[JUMP_FREQ_NUM][OPENED_TS_COUNT+1];
#endif
#if (TS_ACQ_TIMES > 1)
